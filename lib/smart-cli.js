...
exports.new = function (folderName) {
  ...
  var controllerPath = path.join(path.dirname(fs.realpathSync(__filename)), '../lib') + '/basicServer.js';
  var viewPath = path.join(path.dirname(fs.realpathSync(__filename)), '../lib') + '/basicView.html';
